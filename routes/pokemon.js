...
router.post('/', isAuthenticated,validation.savePokemon, pokemonController.createPokemon);

router.put('/:id', isAuthenticated,validation.savePokemon, pokemonController.updatePokemon);
...
router.get('/findByType/:type', pokemonController.getPokemonByType);
